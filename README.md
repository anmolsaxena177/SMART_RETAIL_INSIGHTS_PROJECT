...
<a href="https://github.com/anmolsaxena177/SMART_RETAIL_INSIGHTS_PROJECT/blob/main/sales_transaction-1714027462.csv">Sales Transaction</a> : Records of sales transactions, including transaction ID, customer ID, product ID, quantity purchased, transaction date, and price.

<a href="https://github.com/anmolsaxena177/SMART_RETAIL_INSIGHTS_PROJECT/blob/main/customer_profiles-1-1714027410.cs">Customer_data</a> : Information on customers, including customer ID, age, gender, location, and join date.

<a href="https://github.com/anmolsaxena177/SMART_RETAIL_INSIGHTS_PROJECT/blob/main/product_inventory-1-1714027438.csv">product_data</a> : Data on product inventory, including product ID, product name, category, stock level, and price.
