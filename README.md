...
<a href="https://github.com/anmolsaxena177/SMART_RETAIL_INSIGHTS_PROJECT/blob/main/customer_profiles-1-1714027410.csv">Customer_data</a> : Information on customers, including customer ID, age, gender, location, and join date.

<a href="">product_data</a> : Data on product inventory, including product ID, product name, category, stock level, and price.
